    ...
    <div className="min-h-screen">
      <nav className="fixed top-0 w-full bg-background/95 backdrop-blur-sm z-50 border-b border-border">
        <div className="container mx-auto px-4 py-4 flex justify-between items-center">
          <div className="text-2xl font-bold text-gradient rounded-none">КейтерЕВ</div>
      ...
      <section id="portfolio" className="py-16 px-4">
        <div className="container mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            />
            <img 
              src="https://cdn.poehali.dev/files/195239a0-d177-4560-9f8f-739157d041eb.jpg" 
              alt="Portfolio 2" 
              className="rounded-xl hover:scale-105 transition-transform duration-300 w-full h-64 object-cover"
            />
            <img 
              ...
              <CardContent className="p-6 space-y-6">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href="mailto:info@broscatering.ru" className="text-muted-foreground hover:text-primary transition-colors">caterev-1@mail.ru</a>
                  </div>
                </div>
                <div className="flex items-start gap-4">
